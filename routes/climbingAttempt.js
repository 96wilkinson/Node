...
router.get('/getAllClimbingAttempts', (req, res, next) => {
...
router.delete('/DeleteClimbingAttempt/:id', (req, res, next) => {
...
router.post('/createClimbingAttempt', ({ body }, res, next) => {
...
router.put('/updateClimbingAttempt/:id', (req, res, next) => {
...
// router.patch('/updateClimbingAttempt/:id', (req, res, next) => {
//   ClimbingAttempts.findById(req.params.id, (error, result) => {
//     if (error) {
//       next(error);
//     }
